...
export default function TableItem({
  ...
  return (
    ...
    >
      ...
      <td className={`${checkPercentSign(price_change_percentage_24h)} text-center`}>
        {price_change_percentage_24h.toFixed(2)}%
      </td>
      <td className='text-end font-medium'>{millify(market_cap, { precision: 2 })}</td>
      <td className='text-end font-medium'>{millify(total_volume, { precision: 2 })}</td>
