  ...
  return (
    <>
      <div className='flex gap-2 items-center font-normal'>
        <div
          className='bg-gray-100 flex gap-2 items-center w-52 border p-2 text-black rounded-xl dark:bg-gray-700 dark:border-gray-500 dark:text-gray-400 cursor-pointer'
          onClick={() => {
            setIsOpen(true);
          }}
        >
      ...
      {isOpen && (
        <div
          ref={focusRef}
          className='bg-gray-100 absolute -top-2 z-50 rounded-xl w-full font-normal dark:bg-gray-700 flex flex-col gap-2 h-64 mt-2 p-2 border dark:border-gray-500'
        >
          ...
          <div className='flex flex-col my-2 overflow-auto scrollbar'>
